...
export default function BeneficiaryHomeScreen() {
  ...
  const handleTestPushNotification = async () => {
    try {
      ...
      console.log(
        "🖥️ Modo:",
        isEmulator ? "Emulador (Local)" : "Dispositivo (Push)"
      );
    } catch (error) {
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.menuContainer}>
          ...
          <TouchableOpacity
            style={[styles.menuButton, styles.beneficiaryButton]}
            onPress={() => navigation.navigate("MyPickups" as never)}
          >
            <Text style={styles.buttonIcon}>📋</Text>
            <Text style={styles.buttonText}>Mis Recogidas</Text>
            <Text style={styles.buttonDescription}>
              Historial y seguimiento de tus recogidas
            </Text>
          </TouchableOpacity>
