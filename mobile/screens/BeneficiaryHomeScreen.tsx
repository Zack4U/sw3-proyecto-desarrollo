...
export default function BeneficiaryHomeScreen() {
  ...
  const handleTestPushNotification = async () => {
    try {
      ...
      Alert.alert('✅ Notificación Enviada', message, [{ text: 'Perfecto', style: 'default' }]);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        <View style={styles.menuContainer}>
          {/* Ver establecimientos (se incluyó desde HEAD) */}
          <TouchableOpacity
          ...
          >
            ...
            <Text style={styles.buttonDescription}>Explora los puntos de donación cercanos</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonDescription}>Explora todos los alimentos donados</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.buttonDescription}>Simula notificación al establecimiento</Text>
            {expoPushToken && <Text style={styles.tokenStatusSmall}>✅ Token registrado</Text>}
      ...
      {/* Modal de perfil */}
      <ProfileModal visible={profileModalVisible} user={user} onClose={() => setProfileModalVisible(false)} />
    </View>
  );
}
