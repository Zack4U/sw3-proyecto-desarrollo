import { PrismaClient, FoodStatus, FoodCategory, UnitOfMeasure } from '@prisma/client';
...
export async function seedFoods(prisma: PrismaClient) {
  ...
  const foods = [
    ...
    },
    {
      ...
      category: FoodCategory.COOKIES_AND_DESSERTS,
      quantity: 24,
      unitOfMeasure: UnitOfMeasure.UNIT,
      status: FoodStatus.AVAILABLE,
    ...
    // Alimentos para Restaurante La Esquina (establishmentId: 223e4567-e89b-12d3-a456-426614174001)
    {
      ...
      category: FoodCategory.PREPARED_FOOD,
      quantity: 2.5,
    ...
    },
    {
      ...
      category: FoodCategory.SOUPS_AND_CREAMS,
      quantity: 3,
    ...
    },
    {
      ...
      quantity: 8,
      unitOfMeasure: UnitOfMeasure.DOZEN,
      status: FoodStatus.AVAILABLE,
    ...
    },
    {
      ...
      category: FoodCategory.COLD_CUTS,
      quantity: 1.5,
      unitOfMeasure: UnitOfMeasure.KILOGRAM,
      status: FoodStatus.AVAILABLE,
